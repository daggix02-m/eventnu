  ...
  return (
    <div className="mx-auto w-full max-w-[42rem] space-y-xl">
      <header className="space-y-sm">
        <h1 className="font-display text-display-lg-mobile md:text-display-lg text-on-surface">Experiences</h1>
      ...
      {!authLoading && isAuthenticated && (
        <CreateExperienceForm initialEventId={eventSlug ? initialEventId : undefined} eventTitle={preselectedEvent?.title} />
      )}
