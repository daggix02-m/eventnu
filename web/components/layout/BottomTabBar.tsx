...
export function BottomTabBar() {
  ...
  return (
    <div className="fixed bottom-[calc(var(--keyboard-inset,0px)_+_var(--safe-area-bottom,0px))] inset-x-0 z-60 md:hidden flex justify-center px-4 pointer-events-none">
