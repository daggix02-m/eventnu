        ...
        <div className="flex flex-col lg:flex-row items-center gap-xl">
          ...
          <div ref={mockupRef} className="flex-1 w-full flex justify-center">
            <div className="relative">
              ...
              <div className="relative w-[280px] md:w-[320px] h-[520px] rounded-[40px] border-[8px] border-surface-container-high bg-background shadow-2xl shadow-black/60 overflow-hidden flex flex-col">
                {/* Notch */}
                <div className="absolute top-2.5 left-1/2 -translate-x-1/2 w-24 h-4 bg-black rounded-full z-20" aria-hidden="true" />
                ...
                <div className="flex flex-col items-center justify-between flex-1 pt-8 pb-4 text-center px-sm">
                  ...
                  <div className="space-y-xs">
                    ...
                    <h4 className="font-display text-[14px] font-bold text-white">Event Nu Entry</h4>
                  </div>
                  ...
                  <div className="relative w-44 h-44 rounded-2xl bg-zinc-950 border border-outline-variant/30 flex items-center justify-center overflow-hidden">
                    ...
                    {scanState === "scanning" && (
                      <div
                        ...
                        style={{ animation: prefersReducedMotion ? "none" : "scan-sweep 1.5s ease-in-out infinite" }}
                        aria-hidden="true"
                      />
                    )}
                    ...
                    {scanState === "valid" ? (
                      <div className="flex flex-col items-center gap-xs animate-in fade-in duration-300">
                        ...
                        <span className="font-mono text-[11px] text-green-400 font-bold">VALID</span>
                      </div>
                    ) : (
                    ...
                    >
                      {scanState === "valid" ? (
                        <>
                          ...
                          <span className="block font-mono text-[10px] text-on-surface-variant">Abel Solomon — VIP Pass</span>
                        </>
                      ) : (
                        <>
              ...
              >
                ...
                <span className="font-mono text-[11px] text-tertiary font-bold">Real-time sync</span>
              </div>
            </div>
          </div>
          ...
          <div ref={textRef} className="flex-1 space-y-md text-left">
            ...
            <p className="text-on-surface text-body-lg leading-relaxed opacity-0">
              Scan tickets in seconds with the Event Nu Organizer App. Works
              offline, syncs in real-time across multiple devices, and handles
              gate lookup effortlessly.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-sm pt-sm opacity-0">
              {FEATURES.map((f) => (
                ...
                >
                  ...
                  <div>
                    <h4 className="font-display text-[14px] font-bold text-white mb-0.5">{f.title}</h4>
