...
import { Zap, Wallet, Search, BarChart3, CreditCard, Instagram } from 'lucide-react'
      ...
      <Container>
        ...
        >
          ...
          >
            ...
            {/* Left accent line */}
            <div
              className="absolute left-0 top-0 bottom-0 w-[4px] bg-gradient-to-b from-primary via-secondary to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              aria-hidden="true"
            />

            <div className="relative z-10 flex items-start gap-lg">
              <div
                className={`w-16 h-16 rounded-2xl border flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300 ${featuredPillar.iconBg}`}
              >
                <featuredPillar.icon
                  className={`w-8 h-8 ${featuredPillar.iconColor}`}
                  aria-hidden="true"
                />
              </div>
          ...
          {regularPillars.map((pillar) => (
            ...
            >
              ...
              />
              <div
                className="absolute left-0 top-0 bottom-0 w-[3px] bg-gradient-to-b from-current to-transparent opacity-0 group-hover:opacity-60 transition-opacity duration-400"
                aria-hidden="true"
              />

              <div className="relative z-10 space-y-md">
                <div
                  className={`w-12 h-12 rounded-xl border flex items-center justify-center group-hover:scale-110 transition-transform duration-300 ${pillar.iconBg}`}
                >
