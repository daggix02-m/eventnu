              ...
              <div className="relative z-10 space-y-sm">
                ...
                <div className="rounded-xl bg-surface/60 border border-outline-variant/40 overflow-hidden ring-1 ring-primary/20">
                  <div className="flex items-center gap-sm p-sm">
                    ...
                    {preview && (
                      <div className="text-right shrink-0">
                        <span className="font-display text-[18px] font-extrabold text-secondary">
                          {preview.price}
                        </span>
                      </div>
                    )}
                  ...
                  <div className="flex items-center gap-xs px-sm pb-sm border-t border-outline-variant/20 pt-xs">
                    {['Telebirr', 'CBE Birr', 'Chapa'].map((p) => (
                      <span
                        key={p}
                        className="px-xs py-0.5 bg-primary/10 border border-primary/20 rounded font-mono text-[9px] text-primary"
                      >
                        {p}
                      </span>
                    ))}
                    <span className="ml-auto font-mono text-[9px] text-green-400 flex items-center gap-0.5">
                      <span
                        className="w-1 h-1 bg-green-400 rounded-full inline-block animate-pulse"
                        aria-hidden="true"
                      />
                      No platform fee
                    </span>
                ...
                {nextPreview && (
                  <div className="rounded-xl bg-surface/30 border border-outline-variant/25 p-sm flex items-center gap-sm opacity-70">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-display text-[13px] font-bold text-white/80 truncate">
                        {nextPreview.title}
                      </h4>
                    ...
                    <span className="font-display text-[14px] font-extrabold text-secondary/70 shrink-0">
                      {nextPreview.price}
                    </span>
                  </div>
                )}
                ...
                <div className="grid grid-cols-3 gap-xs">
                  {[
                    ...
                    <div
                      key={label}
                      className="rounded-lg bg-surface-container/50 border border-outline-variant/20 p-xs text-center"
                    >
                      <Icon
                        className="w-3.5 h-3.5 text-primary mx-auto mb-0.5"
                        aria-hidden="true"
                      />
                      <p className="font-display text-[13px] font-bold text-white leading-none">
                        {value}
                      </p>
