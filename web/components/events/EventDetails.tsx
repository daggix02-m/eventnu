    ...
    <div className="space-y-xl">
      ...
      {event.teaser_video_url && (
        <button
          ...
          onClick={() => event.teaser_video_url && window.open(event.teaser_video_url, "_blank", "noopener,noreferrer")}
        >
          ...
          <div className="absolute bottom-md left-md">
            <p className="font-mono text-label-sm text-white uppercase tracking-widest">Watch Teaser</p>
          </div>
        </button>
      )}
    </div>
