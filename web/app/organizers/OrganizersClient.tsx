...
export function OrganizersClient({
  ...
  return (
    <div className="relative min-h-screen bg-background text-on-background overflow-hidden selection:bg-primary/30 selection:text-white">
      ...
      <div className="absolute top-[-100px] left-1/4 w-[500px] h-[500px] bg-primary/10 rounded-full blur-[120px] pointer-events-none -translate-x-1/2" aria-hidden="true" />
      <div className="absolute top-[400px] right-[-200px] w-[600px] h-[600px] bg-secondary/5 rounded-full blur-[140px] pointer-events-none" aria-hidden="true" />
      <div className="absolute bottom-[200px] left-[-150px] w-[500px] h-[500px] bg-tertiary/10 rounded-full blur-[100px] pointer-events-none" aria-hidden="true" />
