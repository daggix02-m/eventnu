...
const CATEGORIES = [
  { name: "Music", slug: "music", description: "Live music concerts, DJ sets, and performances across the city.", icon: "music", sortOrder: 0 },
  { name: "Arts & Culture", slug: "arts-culture", description: "Art exhibitions, galleries, film, and cultural events.", icon: "palette", sortOrder: 1 },
  { name: "Nightlife", slug: "nightlife", description: "Clubs, parties, and after-dark experiences.", icon: "moon", sortOrder: 2 },
  { name: "Food & Drink", slug: "food-drink", description: "Food festivals, tastings, and culinary gatherings.", icon: "utensils-crossed", sortOrder: 3 },
  { name: "Sports & Fitness", slug: "sports-fitness", description: "Runs, tournaments, and fitness events.", icon: "dumbbell", sortOrder: 4 },
  { name: "Tech & Innovation", slug: "tech-innovation", description: "Tech meetups, conferences, and innovation showcases.", icon: "cpu", sortOrder: 5 },
  { name: "Family", slug: "family", description: "Kid-friendly days out and family get-togethers.", icon: "baby", sortOrder: 6 },
];

const FEATURED_SECTIONS = [
  { slug: "editors_choice", label: "Editor's Choice", description: "Staff picks", enabled: true, sortOrder: 0 },
  { slug: "trending", label: "Trending", description: "Most popular right now", enabled: true, sortOrder: 1 },
  { slug: "new_and_noteworthy", label: "New & Noteworthy", description: "Recently added events", enabled: true, sortOrder: 2 },
];
...
const EVENTS: SeedEvent[] = [
  {
    ...
    venue: "Pulp Lounge", address: "Old Airport, Addis Ababa",
    price: "300 ETB", dayOffset: 2, hour: 21,
    featuredSection: "editors_choice", weekly: true,
  },
  {
    title: "Hip Hop Night",
    slug: "hip-hop-night",
    ...
    venue: "Jazz Villaggio", address: "Bole, Addis Ababa",
    price: "250 ETB", dayOffset: 3, hour: 20,
    featuredSection: "trending", weekly: true,
  },
  {
    title: "Afro Heat",
    slug: "afro-heat",
    ...
    venue: "Flirt Lounge", address: "Bole Medhanealem, Addis Ababa",
    price: "200 ETB", dayOffset: 4, hour: 22,
  },
  {
    ...
    venue: "African Jazz Village", address: "Bole, Addis Ababa",
    price: "350 ETB", dayOffset: 5, hour: 20,
  ...
  },
  {
    ...
    venue: "Yod Abyssinia", address: "Bole, Addis Ababa",
    price: "280 ETB", dayOffset: 6, hour: 19,
  },
  {
    title: "Ertib",
    slug: "ertib",
    ...
    venue: "Black Rose", address: "4 Kilo, Addis Ababa",
    price: "220 ETB", dayOffset: 8, hour: 20,
  },
  {
    title: "Night Shift",
    slug: "night-shift",
    ...
    venue: "Milk Lounge", address: "Bole Atlas, Addis Ababa",
    price: "200 ETB", dayOffset: 9, hour: 23,
    weekly: true,
  },
  {
    title: "Shift",
    ...
    venue: "Pulp Lounge", address: "Old Airport, Addis Ababa",
    price: "250 ETB", dayOffset: 10, hour: 22,
  },
  {
    title: "Utopia Night",
    slug: "utopia-night",
    ...
    venue: "Flirt Lounge", address: "Bole Medhanealem, Addis Ababa",
    price: "300 ETB", dayOffset: 11, hour: 22,
  ...
  },
  {
    ...
    venue: "Jazz Villaggio", address: "Bole, Addis Ababa",
    price: "180 ETB", dayOffset: 12, hour: 21,
  },
  {
    ...
    category: "nightlife",
    description:
      "The mid-week reset — open decks, happy-hour cocktails, and a laid-back crowd.",
    venue: "Salon 5 Café", address: "Bole, Addis Ababa",
    price: null, dayOffset: 3, hour: 19,
  },
  {
    title: "Urban Friends",
    slug: "urban-friends",
    ...
    venue: "African Jazz Village", address: "Bole, Addis Ababa",
    price: "250 ETB", dayOffset: 13, hour: 20,
  },
  {
    title: "Wegdayt",
    slug: "wegdayt",
    ...
    venue: "Yod Abyssinia", address: "Bole, Addis Ababa",
    price: "200 ETB", dayOffset: 15, hour: 19,
  },
  {
    ...
    venue: "The Coffee Room", address: "Sarbet, Addis Ababa",
    price: null, dayOffset: 16, hour: 18,
  },
  {
    title: "Anime Fest",
    slug: "anime-fest",
    ...
    venue: "Black Rose", address: "4 Kilo, Addis Ababa",
    price: "150 ETB", dayOffset: 2, hour: 11,
  ...
  },
  {
    ...
    venue: "Black Rose", address: "4 Kilo, Addis Ababa",
    price: "150 ETB", dayOffset: 5, hour: 11,
  },
  {
    title: "Fashion Lab",
    slug: "fashion-lab",
    ...
    venue: "Pulp Lounge", address: "Old Airport, Addis Ababa",
    price: "400 ETB", dayOffset: 8, hour: 17,
  },
  {
    title: "Sip & Paint",
    slug: "sip-and-paint",
    ...
    venue: "Salon 5 Café", address: "Bole, Addis Ababa",
    price: "600 ETB", dayOffset: 9, hour: 15,
  },
  {
    ...
    venue: "Black Rose", address: "4 Kilo, Addis Ababa",
    price: "100 ETB", dayOffset: 10, hour: 10,
  },
  {
    ...
    venue: "The Coffee Room", address: "Sarbet, Addis Ababa",
    price: null, dayOffset: 12, hour: 14,
  },
  {
    ...
    venue: "Meskel Square", address: "Addis Ababa",
    price: "500 ETB", dayOffset: 13, hour: 8,
  },
  {
    title: "Bloom Week",
    slug: "bloom-week",
    ...
    venue: "Entoto Park", address: "Entoto, Addis Ababa",
    price: "200 ETB", dayOffset: 14, hour: 9,
  },
  {
    title: "Tea Gathering",
    slug: "tea-gathering",
    ...
    venue: "The Coffee Room", address: "Sarbet, Addis Ababa",
    price: "180 ETB", dayOffset: 4, hour: 15,
  },
  {
    title: "Feta Society",
    slug: "feta-society",
    ...
    venue: "Meskel Square", address: "Addis Ababa",
    price: "350 ETB", dayOffset: 6, hour: 18,
  },
  {
    title: "Dimket Fest",
    slug: "dimket-fest",
    ...
    venue: "Entoto Park", address: "Entoto, Addis Ababa",
    price: "150 ETB", dayOffset: 15, hour: 10,
    secondaryCategory: "family",
  },
  {
    title: "Cycle Session",
  ...
  },
  {
    ...
    venue: "Entoto Park", address: "Entoto, Addis Ababa",
    price: "400 ETB", dayOffset: 11, hour: 7,
    featuredSection: "trending",
  },
  {
    ...
    venue: "Entoto Park", address: "Entoto, Addis Ababa",
    price: "300 ETB", dayOffset: 18, hour: 6,
  },
  {
    ...
    venue: "Milk Lounge", address: "Bole Atlas, Addis Ababa",
    price: null, dayOffset: 5, hour: 18,
  },
  {
    title: "Afterwork",
    slug: "afterwork",
    ...
    venue: "Pulp Lounge", address: "Old Airport, Addis Ababa",
    price: null, dayOffset: 12, hour: 18,
  },
  {
    title: "Baby Disco",
    slug: "baby-disco",
    ...
    venue: "Salon 5 Café", address: "Bole, Addis Ababa",
    price: "120 ETB", dayOffset: 6, hour: 10,
  },
  {
    title: "Chimp Event",
    slug: "chimp-event",
    ...
    venue: "Entoto Park", address: "Entoto, Addis Ababa",
    price: "80 ETB", dayOffset: 9, hour: 10,
  },
  {
    title: "Game Night",
    slug: "game-night",
    ...
    venue: "The Coffee Room", address: "Sarbet, Addis Ababa",
    price: "100 ETB", dayOffset: 3, hour: 17,
  },
];
