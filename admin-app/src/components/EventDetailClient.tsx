      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="font-headline text-2xl font-semibold text-foreground tracking-tight">{event.title}</h1>
          </div>
          <div className="flex flex-wrap items-center gap-2 mt-2">
            ...
            <Badge variant="outline" className="capitalize">{event.frequency_type?.replace('_', ' ')}</Badge>
          </div>
        </div>
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {!editMode && event.status !== 'published' && (
            <Button onClick={() => handleStatusAction('published')} disabled={loading} className="gap-2">
          ...
          {!editMode && (
            <Button variant="outline" onClick={() => setShowDeleteDialog(true)} disabled={loading} className="gap-2 text-destructive border-destructive" aria-label="Delete event">
              <Trash2 size={16} />
            </Button>
          )}
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {event.poster_url && (
              <Card className="overflow-hidden">
                <div className="aspect-video bg-surface-container-high">
                  <img src={event.poster_url} alt="" width={640} height={360} loading="lazy" className="w-full h-full object-cover" />
                </div>
                <div className="px-4 py-2 font-mono text-[11px] text-muted-foreground uppercase tracking-widest">Poster</div>
              </Card>
            )}
            {event.teaser_video_url && (
              <Card className="overflow-hidden">
                ...
                <div className="px-4 py-2 font-mono text-[11px] text-muted-foreground truncate">{event.teaser_video_url}</div>
              </Card>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="p-6">
              ...
              <div className="space-y-3">
                ...
                <FieldGroup label="Status">
                  <Badge variant={statusVariantMap[event.status] || 'outline'} className="capitalize">{event.status?.replace('_', ' ')}</Badge>
                </FieldGroup>
              </div>
            </Card>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                ...
                <FieldGroup label="Timezone">
                  <p className="font-mono text-sm text-muted-foreground">{event.timezone || '—'}</p>
                </FieldGroup>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                ...
                <FieldGroup label="Action Type"><Badge variant="outline" className="capitalize">{event.action_type?.replace('_', ' ')}</Badge></FieldGroup>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                <FieldGroup label="Source"><Badge variant="outline" className="capitalize">{sourceType}</Badge></FieldGroup>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                <FieldGroup label="Event ID"><p className="font-mono text-xs text-muted-foreground">{event.id}</p></FieldGroup>
          ...
          <Card className="p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {event.status !== 'published' && (
                <Button size="sm" onClick={() => handleStatusAction('published')} disabled={loading} className="gap-1.5">
              ...
              <div className="w-px h-8 bg-outline-variant mx-1" />
              <Button size="sm" variant="outline" onClick={() => setShowDeleteDialog(true)} disabled={loading} className="gap-1.5 text-destructive border-destructive">
